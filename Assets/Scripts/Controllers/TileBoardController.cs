...
[SerializeField][Tooltip("The main tilemap this controls")]
  Tilemap _tilemap;
  ...
  void _updateHeightChunk(Vector2Int chunkKey) {
    ...
    chunkStart.Until(
      ...
      tileLocationKey => {
        ...
        World.CardinalDirection currentSide = World.CardinalDirection.South;
        World.CardinalCorner currentCorner = World.CardinalCorner.SouthWest;
        ...
        foreach(World.CardinalDirection direction in Enum.GetValues(typeof(World.CardinalDirection))) {
          Vector3 currentTopCornerVertex = previousCornerTop + World.CardinalOffsets[direction].X_0_Y();
          ...
          Overworld.Data.Tile? neighbor = Board[tileLocationKey.X_Z() + World.CardinalOffsets[currentSide]];
          ...
          if(neighborHeight < tileHeight && neighborHeight != TileBoard.PitDepth) {
            ...
            bottomCorners[1] = bottomCorners[0] + World.CardinalOffsets[currentSide.TurnCounterClockwise()].X_0_Y();
